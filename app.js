(() => {
  ...
  function RequestsBlock({ T, requests, onAct }) {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: { padding: "4px 0 8px" } }, /* @__PURE__ */ React.createElement(Section, { label: T.requests, count: visible.length, style: { margin: "4px 4px 8px" } }), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 6 } }, visible.map((r) => /* @__PURE__ */ React.createElement("div", { key: r.id, style: {
      ...
      gap: 8
    } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } }, r.punkId != null ? /* @__PURE__ */ React.createElement(DkPunkAvatar, { id: r.punkId, size: 30, radius: 7, fallbackSeed: r.carrier }) : /* @__PURE__ */ React.createElement(DkIdenticon, { seed: r.carrier, size: 30, radius: 7 }), /* @__PURE__ */ React.createElement("div", { style: { minWidth: 0, flex: 1 } }, r.name ? /* @__PURE__ */ React.createElement("div", { style: {
      fontFamily: "var(--ui)",
      fontSize: 13,
      fontWeight: 600,
      color: "var(--text)",
